...
public class Outline : MonoBehaviour {
  ...
  void Awake() {
        ...
        OC = GameObject.Find("UI").GetComponent<OutlineController>();
        // Cache renderers
  ...
  void UpdateMaterialProperties() {
    ...
    IEnumerator OutlineCoroutine()
    {
        yield return new WaitUntil(() => attack.target != gameObject && OC.prev != gameObject);
        enabled = false;
    }
}
